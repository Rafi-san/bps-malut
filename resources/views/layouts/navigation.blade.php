<nav x-data="{ open: false }" class="bg-bps-blue border-b border-blue-900">
            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" class="flex items-center gap-2">
                        ...
                        <span class="text-white font-bold text-sm hidden sm:block">BPS PROVINSI MALUKU UTARA</span>
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('publikasi.index')" :active="request()->routeIs('publikasi.*')">
                        {{ __('Publikasi') }}
                    </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('publikasi.index')" :active="request()->routeIs('publikasi.*')">
                {{ __('Publikasi') }}
            </x-responsive-nav-link>
